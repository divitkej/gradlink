"use client";
/* eslint-disable @typescript-eslint/no-explicit-any -- vendored Three.js component uses the global THREE (untyped) */
...
export function ShaderAnimation() {
  ...
  useEffect(() => {
    ...
    // Reuse Three.js if it's already on the page; otherwise load it once.
    if (window.THREE) {
      start();
    } else {
